...
std::atomic<int>     _num_balancing_calculation_calls(0);
...
std::atomic<double>  _time_balancing_calculation_sum(0.0);
std::atomic<int>     _time_balancing_calculation_count(0);
...
void cham_stats_reset_for_sync_cycle() {
    ...
    _num_balancing_calculation_calls = 0;
    ...
    _time_balancing_calculation_sum = 0.0;
    _time_balancing_calculation_count = 0;
...
void cham_stats_print_stats() {
    ...
    fprintf(cur_file, "Stats R#%d:\t_num_balancing_calculation_calls\t%d\n", chameleon_comm_rank, _num_balancing_calculation_calls.load());
    ...
    cham_stats_print_stats_w_mean(cur_file, "_time_balancing_calculation_sum", _time_balancing_calculation_sum, _time_balancing_calculation_count);
