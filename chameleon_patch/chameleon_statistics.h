...
extern std::atomic<int>     _num_balancing_calculation_calls;
...
extern std::atomic<double>  _time_balancing_calculation_sum;
extern std::atomic<int>     _time_balancing_calculation_count;
