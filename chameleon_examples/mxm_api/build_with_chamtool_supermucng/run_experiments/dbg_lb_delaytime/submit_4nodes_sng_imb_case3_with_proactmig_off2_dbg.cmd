#!/bin/bash
#SBATCH -J promig2_imb3_dbg
#SBATCH -o job_output/out_%j_mxm_cham_dbg_proactmig_off2_case3.txt
#SBATCH -e job_output/err_%j_mxm_cham_dbg_proactmig_off2_case3.txt
#SBATCH -D ./
