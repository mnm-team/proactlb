#!/bin/bash
#SBATCH -J workstealing_imb2
#SBATCH -o job_output/out_%j_mxm_cham_workstealing_case2.txt
#SBATCH -e job_output/err_%j_mxm_cham_workstealing_case2.txt
#SBATCH -D ./
...
export LOG_DIR=/dss/dsshome1/00/di46nig/chameleon-scripts/cham_examples/mxm_api/build_with_chamtool_supermucng/run_experiments/uniform_load/logs/imb_case2
