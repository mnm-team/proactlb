...
mpirun -n ${SLURM_NTASKS} /home/ra56kop/chameleon-scripts/cham_examples/mxm_api/build_with_cham_beast/mxm_api ${MATRIX_SIZE} ${NUM_TASKS} 1> ${LOG_OUT}/out_beast_intel_rep3mig_case3.txt 2> ${LOG_OUT}/err_beast_intel_rep3mig_case3.txt
