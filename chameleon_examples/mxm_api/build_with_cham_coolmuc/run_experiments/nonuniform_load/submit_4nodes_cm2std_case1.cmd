#!/bin/bash
#SBATCH -J base_imb1_nonuni
#SBATCH -o job_output/out_%j_nonuniform_cham_commthread_case1.txt
#SBATCH -e job_output/err_%j_nonuniform_cham_commthread_case1.txt
#SBATCH -D ./
#SBATCH --get-user-env
#SBATCH --clusters=cm2
...
echo "mpirun -n ${SLURM_NTASKS} /dss/dsshome1/lxc0D/ra56kop/chameleon-scripts/cham_examples/mxm_api/build_with_cham_coolmuc/mxm_api non-uniform-imb ${MATRIX_SIZES} ${TASK_AMOUNT} 1.0 1.0"
mpirun -n ${SLURM_NTASKS} /dss/dsshome1/lxc0D/ra56kop/chameleon-scripts/cham_examples/mxm_api/build_with_cham_coolmuc/mxm_api non-uniform-imb ${MATRIX_SIZES} ${TASK_AMOUNT} 1.0 1.0
