#!/bin/bash
#SBATCH -J base_normimb4
#SBATCH -o job_output/out_%j_normimb_cham_commthread_case4.txt
#SBATCH -e job_output/err_%j_normimb_cham_commthread_case4.txt
#SBATCH -D ./
#SBATCH --get-user-env
#SBATCH --clusters=cm2
...
echo "mpirun -n ${SLURM_NTASKS} /dss/dsshome1/lxc0D/ra56kop/chameleon-scripts/cham_examples/mxm_api/build_with_cham_coolmuc/mxm_api uniform-imb ${NUM_TASKS} ${MATRIX_SIZE}"
mpirun -n ${SLURM_NTASKS} /dss/dsshome1/lxc0D/ra56kop/chameleon-scripts/cham_examples/mxm_api/build_with_cham_coolmuc/mxm_api uniform-imb ${NUM_TASKS} ${MATRIX_SIZE}
