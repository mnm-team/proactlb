#!/bin/bash
#SBATCH -J promig1_imb3_uni_dbg
#SBATCH -o job_output/out_%j_imb_chamtool_proactmig_off1_case3.txt
#SBATCH -e job_output/err_%j_imb_chamtool_proactmig_off1_case3.txt
#SBATCH -D ./
#SBATCH --get-user-env
#SBATCH --clusters=cm2
