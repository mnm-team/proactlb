#!/bin/bash
#SBATCH -J promig2_imb3_uni_dbg_itac
#SBATCH -o job_output/out_%j_imb_chamtool_proactmig_off2_itac_case3.txt
#SBATCH -e job_output/err_%j_imb_chamtool_proactmig_off2_itac_case3.txt
#SBATCH -D ./
#SBATCH --get-user-env
#SBATCH --clusters=cm2
...
module load chamtool_pred3_mig1_off2_dbg_itac
...
export VT_LOGFILE_PREFIX=/dss/dsshome1/lxc0D/ra56kop/chameleon-scripts/cham_examples/mxm_api/build_with_chamtool_coolmuc/run_experiments/dbg_lb_delaytime/traces
export LOG_DIR=/dss/dsshome1/lxc0D/ra56kop/chameleon-scripts/cham_examples/mxm_api/build_with_chamtool_coolmuc/run_experiments/dbg_lb_delaytime/logs
