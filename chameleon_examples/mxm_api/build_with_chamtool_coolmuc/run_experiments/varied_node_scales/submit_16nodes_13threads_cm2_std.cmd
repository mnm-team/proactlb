...
#SBATCH -o job_output/out_16nodes_%j_mxm_api_chamtool_pred3_mig0.txt
#SBATCH -e job_output/err_16nodes_%j_mxm_api_chamtool_pred3_mig0.txt
#SBATCH -D ./
#SBATCH --get-user-env
#SBATCH --clusters=cm2
...
export LOG_DIR="/dss/dsshome1/lxc0D/ra56kop/chameleon-scripts/cham_examples/mxm_api/build_with_chamtool_coolmuc/run_experiments/varied_node_scales/logs/16_nodes"
...
DIST_MODE="2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2"
