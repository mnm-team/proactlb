#!/bin/bash
#SBATCH -J proactmig_imb0_uni
#SBATCH -o job_output/out_%j_normimb_chamtool_proactmig_case0.txt
#SBATCH -e job_output/err_%j_normimb_chamtool_proactmig_case0.txt
#SBATCH -D ./
#SBATCH --get-user-env
#SBATCH --clusters=cm2
...
export LOG_DIR=/dss/dsshome1/lxc0D/ra56kop/chameleon-scripts/cham_examples/mxm_api/build_with_chamtool_coolmuc/run_experiments/uniform_load/logs

MATRIX_SIZE="384 384 384 384 384 384 384 384"
NUM_TASKS=400

echo "mpirun -n ${SLURM_NTASKS} /dss/dsshome1/lxc0D/ra56kop/chameleon-scripts/cham_examples/mxm_api/build_with_chamtool_coolmuc/mxm_api uniform-imb ${NUM_TASKS} ${MATRIX_SIZE}"
mpirun -n ${SLURM_NTASKS} /dss/dsshome1/lxc0D/ra56kop/chameleon-scripts/cham_examples/mxm_api/build_with_chamtool_coolmuc/mxm_api uniform-imb ${NUM_TASKS} ${MATRIX_SIZE}
