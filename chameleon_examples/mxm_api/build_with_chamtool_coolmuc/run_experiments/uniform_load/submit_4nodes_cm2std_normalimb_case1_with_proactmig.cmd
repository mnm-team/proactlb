#!/bin/bash
#SBATCH -J proactmig_imb1_uni
#SBATCH -o job_output/out_%j_normimb_chamtool_proactmig_case1.txt
#SBATCH -e job_output/err_%j_normimb_chamtool_proactmig_case1.txt
#SBATCH -D ./
#SBATCH --get-user-env
#SBATCH --clusters=cm2
...
MATRIX_SIZE="512 384 256 256 256 128 128 128"
NUM_TASKS=400
