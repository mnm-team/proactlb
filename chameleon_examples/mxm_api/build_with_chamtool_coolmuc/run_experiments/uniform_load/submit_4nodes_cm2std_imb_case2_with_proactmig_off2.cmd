#!/bin/bash
#SBATCH -J promig2_imb2_uni
#SBATCH -o job_output/out_%j_imb_chamtool_proactmig_off2_case2.txt
#SBATCH -e job_output/err_%j_imb_chamtool_proactmig_off2_case2.txt
#SBATCH -D ./
#SBATCH --get-user-env
#SBATCH --clusters=cm2
