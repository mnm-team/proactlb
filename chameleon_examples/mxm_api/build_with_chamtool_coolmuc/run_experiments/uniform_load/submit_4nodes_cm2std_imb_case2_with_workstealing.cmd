#!/bin/bash
#SBATCH -J workstealing_imb2_uni
#SBATCH -o job_output/out_%j_imb_chamtool_workstealing_case2.txt
#SBATCH -e job_output/err_%j_imb_chamtool_workstealing_case2.txt
#SBATCH -D ./
#SBATCH --get-user-env
#SBATCH --clusters=cm2
...
export LOG_DIR=/dss/dsshome1/lxc0D/ra56kop/chameleon-scripts/cham_examples/mxm_api/build_with_chamtool_coolmuc/run_experiments/uniform_load/logs/imb_case3
