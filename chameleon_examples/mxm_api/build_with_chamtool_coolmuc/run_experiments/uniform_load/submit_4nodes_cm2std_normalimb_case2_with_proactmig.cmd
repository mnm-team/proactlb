#!/bin/bash
#SBATCH -J proactmig_imb2_uni
#SBATCH -o job_output/out_%j_normimb_chamtool_proactmig_case2.txt
#SBATCH -e job_output/err_%j_normimb_chamtool_proactmig_case2.txt
#SBATCH -D ./
#SBATCH --get-user-env
#SBATCH --clusters=cm2
...
MATRIX_SIZE="512 512 384 384 256 256 256 256"
NUM_TASKS=400
