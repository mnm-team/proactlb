#!/bin/bash
#SBATCH -J workstealing_imb1_uni
#SBATCH -o job_output/out_%j_imb_chamtool_workstealing_case1.txt
#SBATCH -e job_output/err_%j_imb_chamtool_workstealing_case1.txt
#SBATCH -D ./
#SBATCH --get-user-env
#SBATCH --clusters=cm2
...
export LOG_DIR=/dss/dsshome1/lxc0D/ra56kop/chameleon-scripts/cham_examples/mxm_api/build_with_chamtool_coolmuc/run_experiments/uniform_load/logs/imb_case1

export TASKS_PER_RANK="400,400,200,200,100,100,100,100"
NUM_TASKS="400 400 200 200 100 100 100 100"
MATRIX_SIZE=512
