#!/bin/bash
#SBATCH -J proactmig_imb4_uni
#SBATCH -o job_output/out_%j_normimb_chamtool_proactmig_case4.txt
#SBATCH -e job_output/err_%j_normimb_chamtool_proactmig_case4.txt
#SBATCH -D ./
#SBATCH --get-user-env
#SBATCH --clusters=cm2
...
MATRIX_SIZE="768 384 128 128 128 128 256 256"
NUM_TASKS=400
