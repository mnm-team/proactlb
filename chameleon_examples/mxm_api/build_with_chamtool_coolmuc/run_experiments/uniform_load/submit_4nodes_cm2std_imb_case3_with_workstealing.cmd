#!/bin/bash
#SBATCH -J workstealing_imb3_uni
#SBATCH -o job_output/out_%j_imb_chamtool_workstealing_case3.txt
#SBATCH -e job_output/err_%j_imb_chamtool_workstealing_case3.txt
#SBATCH -D ./
#SBATCH --get-user-env
#SBATCH --clusters=cm2
