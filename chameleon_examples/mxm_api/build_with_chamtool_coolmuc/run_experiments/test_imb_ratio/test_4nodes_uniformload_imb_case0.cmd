...
#SBATCH -o job_output/out_%j_mxm_chamtool_case0.txt
#SBATCH -e job_output/err_%j_mxm_chamtool_case0.txt
#SBATCH -D ./
#SBATCH --get-user-env
#SBATCH --clusters=cm2
...
export LOG_DIR="/dss/dsshome1/lxc0D/ra56kop/chameleon-scripts/cham_examples/mxm_api/build_with_chamtool_coolmuc/run_experiments/test_imb_ratio/logs"
...
MATRIX_SIZE=256
NUM_TASKS="300 300 300 300 300 300 300 300"
