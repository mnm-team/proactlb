...
mpirun -n ${SLURM_NTASKS} /home/ra56kop/chameleon-scripts/cham_examples/mxm_api/build_with_chamtool_beast/mxm_api ${MATRIX_SIZE} ${NUM_TASKS} 2> ${LOG_OUT}/err_beast_proactmig_off2_case0.txt
