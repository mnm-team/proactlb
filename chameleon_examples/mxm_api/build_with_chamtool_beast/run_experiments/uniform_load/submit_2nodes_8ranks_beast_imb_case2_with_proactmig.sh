...
export LOG_DIR=/home/ra56kop/chameleon-scripts/cham_examples/mxm_api/build_with_chamtool_beast/run_experiments/uniform_load/logs/imb_case2
...
mpirun -n ${SLURM_NTASKS} -ppn 4 --host rome1,rome2 /home/ra56kop/chameleon-scripts/cham_examples/mxm_api/build_with_chamtool_beast/mxm_api ${MATRIX_SIZE} ${NUM_TASKS} 2> ${LOG_OUT}/err_beast_proactmig_case2.txt
