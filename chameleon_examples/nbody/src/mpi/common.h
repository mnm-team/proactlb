...
static const float default_domain_size_x  = 1.0e+10; /* m, 10 bilion  */
static const float default_domain_size_y  = 1.0e+10; /* m, 10 bilion  */
static const float default_domain_size_z  = 1.0e+10; /* m, 10 bilion */
